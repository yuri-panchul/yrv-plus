...
#  dump .text HexText program.mem32 - dump segment .text to program.hex file in HexText format

is_command_available_or_error_and_sudo_apt_install java
java -jar "$rars_path" nc a ae1 dump .text HexText program.mem32 ../program.S
