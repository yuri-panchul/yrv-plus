...
#define port0 (* (volatile unsigned *) IO_PORT00_ADDR )
#define port1 (* (volatile unsigned *) IO_PORT16_ADDR )
#define port2 (* (volatile unsigned *) IO_PORT32_ADDR )
#define port3 (* (volatile unsigned *) IO_PORT48_ADDR )
#define port4 (* (volatile unsigned *) IO_PORT54_ADDR )
#define port5 (* (volatile unsigned *) IO_PORT60_ADDR )
#define port6 (* (volatile unsigned *) IO_PORT76_ADDR )
